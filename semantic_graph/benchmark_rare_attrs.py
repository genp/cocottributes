...
if __name__ == "__main__":
    ...
    # pick top N_i images most likely to contain rare attribute x_i
    # calculate N_i from training set
    # save NUMQ' -> updated average number of queries asked counting for rare attribute questions
    


    joblib.dump(res,'data/attr_rec_benchmark_mle_et_all_object_hier_rare.jbl')
    sys.exit()
    ...
    joblib.dump(res,'data/attr_rec_benchmark_mle_et_all_object_attr_only_rare.jbl')
