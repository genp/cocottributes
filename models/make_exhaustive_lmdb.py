...
# TODO: redo this split to put half of the ex set in val and half in train...
...
# save_path = '/data/gen_data/COCO/caffemodels_exhaustive_split'
save_path = '/data/gen_data/COCO/caffemodels_exhaustive_w_obj'
